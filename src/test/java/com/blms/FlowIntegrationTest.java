...
class FlowIntegrationTest {
    ...
    void b2_pagination() {
        ...
        ApiResult<Object> full = collRead.list("dispatches", null, null, null, null, null, null, null);
        check("B2：不带 page → 全量返回（向后兼容）", full.isOk() && full.getData() instanceof List<?> l && l.size() == total);
        // page=1 size=20 → {list,total,page,size}
        @SuppressWarnings("unchecked")
        Map<String, Object> p1 = (Map<String, Object>) collRead.list("dispatches", 1, 20, null, null, null, null, null).getData();
        ...
        if (total > 20) {
            @SuppressWarnings("unchecked")
            Map<String, Object> p2 = (Map<String, Object>) collRead.list("dispatches", 2, 20, null, null, null, null, null).getData();
        ...
        @SuppressWarnings("unchecked")
        Map<String, Object> po = (Map<String, Object>) collRead.list("dispatches", 99999, 20, null, null, null, null, null).getData();
        check("B2：超范围页 → 空 list + total 不变", ((List<?>) po.get("list")).isEmpty() && (int) po.get("total") == total);
        // size 上限 200
        @SuppressWarnings("unchecked")
        Map<String, Object> ps = (Map<String, Object>) collRead.list("dispatches", 1, 1000, null, null, null, null, null).getData();
        ...
        @SuppressWarnings("unchecked")
        Map<String, Object> up = (Map<String, Object>) collRead.list("dispatches", 1, 20, null, null, null, null, null).getData();
